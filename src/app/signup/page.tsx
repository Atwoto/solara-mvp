...
import { 
    ...
    LockClosedIcon, SunIcon // <-- Added SunIcon
} from '@heroicons/react/24/solid';
import AuthInput from '@/components/auth/AuthInput';
import AuthFormContainer from '@/components/auth/AuthFormContainer'; // We'll need this to wrap the form

// Helper component for the floating background icons
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center w-full">
            ...
            <AuthFormContainer>
                {/* All your existing form JSX now goes inside the AuthFormContainer */}
