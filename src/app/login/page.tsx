...
// The skeleton remains the same, but we'll style its container.
    ...
    return (
        <div className="w-full max-w-md p-10 space-y-8 bg-white rounded-2xl shadow-2xl animate-pulse">
            ...
            <div className="relative flex py-3 items-center">
                ...
                <span className="flex-shrink mx-4 h-4 bg-gray-200 rounded w-8"></span>
                <div className="flex-grow border-t border-gray-200"></div>
            </div>
            <div className="space-y-6">
                ...
                <div className="h-12 bg-gray-300 rounded-lg mt-12"></div>
            </div>
        </div>
    );
}
...
export default function LoginPage() {
  return (
    // A beautiful, subtle gradient background that evokes a clear sky.
    // The main container now orchestrates the split-screen layout.
