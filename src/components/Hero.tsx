...
const slideData = [
  {
    ...
    icon: GlobeAltIcon,
    preTitle: "A World Innovator in Energy",
    line1: "Manageable, Reliable",
    line2: "Affordable Energy!",
    animationClass: "animate-kenburns-br",
  },
  {
    image: "/images/back2.jpg",
    icon: SunIcon,
    preTitle: "Evergreen Producer of Solar Energy",
    line1: "Powering Tomorrow,",
    line2: "Sustainably.",
    animationClass: "animate-kenburns-tl",
  },
  {
    image: "/images/back3.jpg",
    icon: BoltIcon,
    preTitle: "Biggest Producer of Clean Energy",
    line1: "Harnessing Power",
    line2: "From the Sun.",
    animationClass: "animate-kenburns-bl",
  },
];
...
const Hero = () => {
  ...
  return (
    <section className="relative -mt-[108px] h-screen overflow-hidden bg-deep-night text-shadow">
          ...
          {slideData.map((slide, index) => (
            <SwiperSlide key={index}>
              <div className="absolute inset-0">
                {/* Optimized background image with the Ken Burns effect */}
                <div className={`absolute inset-0 ${slide.animationClass}`}>
                  <Image
                    src={slide.image}
                ...
                {/* The refined overlay */}
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(0,0,0,0.1)_0%,_rgba(0,0,0,0.6)_100%)] z-10"></div>
              </div>
            </SwiperSlide>
          ))}
        </Swiper>
      ...
      <div
        className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 w-[calc(100%-2rem)] max-w-sm md:max-w-md lg:max-w-lg"
        aria-hidden="true"
      >
        <AnimatePresence>
          {isClient && (
      ...
      <style jsx global>{`
        ...
        .animate-kenburns-br {
          animation: kenburns-br 10s ease-out forwards;
        }
        ...
        .animate-kenburns-tl {
          animation: kenburns-tl 10s ease-out forwards;
        }
        ...
        .animate-kenburns-bl {
          animation: kenburns-bl 10s ease-out forwards;
        }
