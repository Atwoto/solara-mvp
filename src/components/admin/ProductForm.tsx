...
// --- THE FIX: Using a named export 'export const' to ensure consistency ---
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
                ...
                <motion.div variants={itemVariants} className="p-6 bg-white rounded-xl shadow-sm border border-slate-200/80">
                    ...
                    <textarea name="description" id="description" rows={8} value={productData.description || ''} onChange={handleInputChange} className="block w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-solar-flare-start focus:border-solar-flare-start sm:text-sm" placeholder="Detailed product description..."></textarea>
                </motion.div>
            </div>
