...
import { 
    ...
    PhotoIcon, UsersIcon, MapIcon, RectangleGroupIcon // <-- NEW ICON
...
const navigation = [
  ...
  { name: 'Service Categories', href: '/admin/service-categories', icon: RectangleGroupIcon }, // <-- ADDED THIS LINE
  ...
  { name: 'County Resources', href: '/admin/county-resources', icon: MapIcon },
];
