...
const GuestCheckoutModal = ({
  ...
  const switchMode = (mode: AuthMode | null) => {
    setAuthMode(mode);
    resetForm();
  };
      ...
      >
        ...
        >
          <div className="relative bg-gradient-to-r from-solar-flare-start to-solar-flare-end p-6 text-center">
            ...
            <p className="text-deep-night/80 mt-1">
          ...
          <div className="p-6">
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                className={`w-full py-4 px-6 border-2 rounded-lg text-lg font-medium transition-all ${
                  authMode === "signup"
                    ? "border-solar-flare-end bg-solar-flare-start/10 text-solar-flare-end"
                    : "border-gray-300 text-gray-700 hover:border-solar-flare-start hover:bg-gray-50"
                }`}
              >
                Sign Up With Email
              </button>
            ...
            {/* Show forms only when a mode is selected */}
              ...
              {authMode && (
                ...
                >
                  ...
                  <button
                    ...
                    className="mb-4 flex items-center text-sm text-gray-600 hover:text-gray-800 transition-colors"
                  >
                    <svg
                  ...
                  {authMode === "guest" && (
                    <form onSubmit={handleGuestCheckout} className="space-y-4">
                      ...
                      <p className="text-xs text-gray-500">
                        We'll use this email to send you order updates. You can
                        create an account later to track your orders.
                      </p>
                      <button
                        type="submit"
                        disabled={isLoading}
